...
first column but can be at any row. He can move only (right->,right up
...
right. Find out maximum amount of gold he can collect. Solve using
Dynamic programming!
